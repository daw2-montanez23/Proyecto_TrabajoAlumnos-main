import { U as User, P as Perfil } from "./main-30978cab.js";
const registroVista = {
  template: `
    <div
  ...
  >
    <div class="col-12 col-md-4">
        ...
        <form id="form_registro" class="p-3" novalidate>
            ...
            <input type="text" class="form-control" value="" placeholder ="Carlos" id="nombre" required />
            <div class="invalid-feedback">El nombre no es correcto</div>
  
            <label class="mt-3 form-label" for="apellidos">Apellidos: </label>
            <input type="text" class="form-control" value="" placeholder = "Arrebola Apruebame" id="apellidos" required />
            ...
            <hr class="mt-5" />
            <button type="submit" class="mt-1 btn btn-light w-100">
  ...
  script: () => {
    document.querySelector("#form_registro").addEventListener("submit", async function(e) {
      ...
      try {
        ...
        console.log(error);
        alert("No se a podido registrar el usuario");
      }
    });
  }
};
